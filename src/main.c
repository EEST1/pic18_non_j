...
/*#ifdef __XC8__
    ...
    #warning "This bootloader project must be built in PRO mode to fit within the reserved region.  Double click this message for more details."
    #endif
    #if __XC8_VERSION < 1210
    #warning "This code is only intended for XC8 v1.21 or later.  Please upgrade to the latest compiler version."
    #endif
#endif*/
